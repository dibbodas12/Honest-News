...
const newsCategoryInContainer = document.getElementById("newsCategoryIn-container");
...
<div class="col-md-4">
    <img src="${news.thumbnail_url}" class="img-fluid rounded-start mb-4 w-75 mx-auto " alt="...">
</div>
...
<div class="col-md-8">
  ...
  <div class = 'd-flex justify-content-between align-items-center'>
      ...
      <div>
           ...
           <span> ${news.total_view ? news.total_view : "no views found"}</span>
      </div>
...
const displayNewsDetails = (newsDetail) => {
  ...
  modalTitle.innerText = newsDetail.author.name ? newsDetail.author.name: "No data found";

  const newsDetailPart = document.getElementById("news-details");

  newsDetailPart.innerHTML = `

  <p>Published Date :${newsDetail.author.published_date ? newsDetail.author.published_date : "No data found"}</p>

  <img style = 'width :15rem' src ='${newsDetail.author.img}'>
  <p class = 'py-4'>total Views :${newsDetail.total_view ? newsDetail.total_view : "No views Found"}</p>`;
};
